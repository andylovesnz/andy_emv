...
typedef struct {
    ...
    uint8_t ATS_len; //Answer to select  
    uint8_t ATS[256]; 
    uint8_t respSELPPSE_len; 
    uint8_t respSELPPSE[255];
    uint8_t respSELAID_len;
    uint8_t respSELAID[255];
    uint8_t respPDOLMSR[255];
    uint8_t respPDOLMSR_len;
    uint8_t respPDOLEMV[255];
    uint8_t respPDOLEMV_len; 
    uint8_t respRR11[255];
    uint8_t respRR11_len;
    uint8_t respRR21[255];
    uint8_t respRR21_len;
    uint8_t respRR31[255];
    uint8_t respRR31_len;
    uint8_t respRR32[255];
    uint8_t respRR32_len;
    uint8_t respRR41[255];
    uint8_t respRR41_len;
    uint8_t respRR42[255];
    uint8_t respRR42_len;
    uint8_t respAC[255];
    uint8_t respAC_len;
}clonedcard;
